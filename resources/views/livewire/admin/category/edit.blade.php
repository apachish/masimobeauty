    ...
    <div class="card-body">
      <form wire:submit.prevent="update">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" wire:model='editable.is_parent' id='is_parent' > Yes
        </div>
        {{-- {{$parent_cats}} --}}
        {{-- {{$category}} --}}

      <div class="form-group {{((data_get($editable,'is_parent')==1) ? 'd-none' : '')}}" id='parent_cat_div'>
          <label for="parent_id">Parent Category</label>
          <select wire:model="editable.parent_id" class="form-control">
            ...
            function initSummernote() {
                ...
                $textarea.summernote({
                    ...
                    callbacks: {
                        ...
                        @this.set('editable.summary', summernoteContent);
                        }
                    }
                });
