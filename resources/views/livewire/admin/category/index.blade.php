...
{{--                    <form method="POST" action="{{route('category.destroy',[$category->id])}}" class="delete-form" id="delete-form-{{$category->id}}">--}}
{{--                      @csrf--}}
{{--                      @method('delete')--}}
{{--                          <button type="button" class="btn btn-danger btn-sm dltBtn" data-id={{$category->id}} data-form-id="delete-form-{{$category->id}}" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>--}}
{{--                        </form>--}}
                        <button wire:click.prevent="destroy({{$category->id}})" onclick="event.preventDefault(); deleteCategory({{$category->id}}); return false;" class="btn btn-danger btn-sm dltBtn" data-id={{$category->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
