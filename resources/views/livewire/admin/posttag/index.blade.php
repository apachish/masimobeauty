...
@push('scripts')
  ...
  <script>
      ...
      function initDataTable() {
          if ($('#post-category-dataTable').length) {
              // Destroy existing instance if any
              if ($.fn.DataTable.isDataTable('#post-category-dataTable')) {
                  $('#post-category-dataTable').DataTable().destroy();
                  dataTableInstance = null;
              }

              if (!dataTableInstance) {
                  dataTableInstance = $('#post-category-dataTable').DataTable( {
                      "columnDefs":[
                          {
                              "orderable":false,
                              "targets":[3,4]
