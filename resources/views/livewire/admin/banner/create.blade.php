...
<div class="card">
    ...
    <div class="card-body">
      <form wire:submit.prevent="save">
        ...
        <input id="inputTitle" type="text" wire:model="banner.title" placeholder="Enter title" class="form-control">
        @error('banner.title')
        ...
        <div class="input-group">
          ...
          <input id="thumbnail" class="form-control" type="text" wire:model="banner.photo" wire:key="photo-input">
        </div>
        ...
        <div class="form-group">
          ...
          <select wire:model="banner.status" class="form-control">
...
<script>
    ...
    $('#lfm').filemanager('image');
        ...
        function initSummernote() {
            ...
            const contentToSet = summernoteContent || @this.get('banner.description') || '';
        ...
        tabsize: 2,
                ...
                callbacks: {
                    onChange: function(contents, $editable) {
                        ...
                        @this.set('banner.description', contents);
                    }
                }
            });
            ...
            if ($textarea.length && $textarea.next('.note-editor').length) {
                try {
                    ...
                    if (content) {
                        ...
                        @this.set('banner.description', content);
                    }
                } catch(e) {
                    // Ignore
                }
