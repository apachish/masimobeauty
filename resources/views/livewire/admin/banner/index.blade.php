            ...
            @foreach($banners as $banner)
                <tr>
                    ...
                    <td>
                        ...
                        <button wire:click.prevent="destroy({{$banner->id}})" onclick="event.preventDefault(); deleteBanner({{$banner->id}}); return false;" class="btn btn-danger btn-sm dltBtn" data-id={{$banner->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    </td>
                    {{-- Delete Modal --}}
